...
const DeploymentDashboard: React.FC = () => {
  ...
  return (
    <div className="container py-8">
      ...
      <DeploymentSections steps={steps} />
    </div>
  );
};

// Components séparés pour améliorer la maintenabilité
...
const DashboardHeader: React.FC<{
  ...
  onCancel: () => void;
  onRollback: () => void;
}> = ({ isDeploying, onDeploy, onCancel, onRollback }) => (
...
const DeploymentStatusCards: React.FC<{
  isDeploying: boolean;
  logs: Array<{id: string, message: string, type: string, timestamp: Date}>;
  clearLogs: () => void;
}> = ({ isDeploying, logs, clearLogs }) => (
...
const DeploymentSections: React.FC<{
  steps: Array<any>;
}> = ({ steps }) => (
  <>
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
